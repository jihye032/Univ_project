...
static cml::quaterniond y180(cos(M_PI/2), 0, sin(M_PI/2), 0);
...
cml::matrix44d_c Camera::GetGLProjectionMatrix() const
{
	cml::matrix44d_c m;
	if ( flag_ortho )
	{
...
cml::matrix44d_c Camera::GetGLViewMatrix() const
{
	cml::matrix44d_c m;
...
cml::matrix44d_c Camera::GetGLViewMatrixInverse() const
{
